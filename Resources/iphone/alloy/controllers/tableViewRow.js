function Controller() {
    ...
    $.__views.__alloyId106.add($.__views.thumbImage);
    ...
    $.__views.__alloyId107.add($.__views.nameLabel);
    ...
    $.__views.__alloyId107.add($.__views.dateLabel);
    ...
    $.__views.__alloyId105.add($.__views.textLabel);
    ...
    $.__views.__alloyId105.add($.__views.extLabel);
    $.__views.postAttachmentImage = Ti.UI.createImageView({
        id: "postAttachmentImage"
    });
    $.__views.__alloyId105.add($.__views.postAttachmentImage);
    ...
    $.__views.__alloyId105.add($.__views.rowFooterView);
