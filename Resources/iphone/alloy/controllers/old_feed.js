function Controller() {
    ...
    $.__views.photoView.add($.__views.__alloyId76);
    ...
    __alloyId79.push($.__views.CameraOptionsColumns);
    $.__views.__alloyId80 = Ti.UI.createPickerRow({
        title: "Choose Existing Photo",
        id: "__alloyId80"
    });
    $.__views.CameraOptionsColumns.addRow($.__views.__alloyId80);
    $.__views.__alloyId81 = Ti.UI.createPickerRow({
        title: "Take New Photo",
        id: "__alloyId81"
    });
    $.__views.CameraOptionsColumns.addRow($.__views.__alloyId81);
    $.__views.photoOptions.add(__alloyId79);
    ...
    $.__views.videoView.add($.__views.__alloyId82);
    ...
    __alloyId85.push($.__views.CameraOptionsColumns);
    $.__views.__alloyId86 = Ti.UI.createPickerRow({
        title: "Choose Existing Video",
        id: "__alloyId86"
    });
    $.__views.CameraOptionsColumns.addRow($.__views.__alloyId86);
    $.__views.__alloyId87 = Ti.UI.createPickerRow({
        title: "Take New Video",
        id: "__alloyId87"
    });
    $.__views.CameraOptionsColumns.addRow($.__views.__alloyId87);
    $.__views.videoOptions.add(__alloyId85);
