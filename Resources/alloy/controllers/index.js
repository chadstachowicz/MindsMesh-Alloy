function Controller() {
    ...
    goLogin ? $.__views.__alloyId49.addEventListener("click", goLogin) : __defers["$.__views.__alloyId49!click!goLogin"] = true;
    ...
    $.__views.mainView.add($.__views.__alloyId50);
    goSettings ? $.__views.__alloyId50.addEventListener("click", goSettings) : __defers["$.__views.__alloyId50!click!goSettings"] = true;
    ...
    _.extend($, $.__views);
    $.indexWindow.open();
    __defers["$.__views.__alloyId49!click!goLogin"] && $.__views.__alloyId49.addEventListener("click", goLogin);
    __defers["$.__views.__alloyId50!click!goSettings"] && $.__views.__alloyId50.addEventListener("click", goSettings);
