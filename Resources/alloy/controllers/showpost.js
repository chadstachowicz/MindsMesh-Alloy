function Controller() {
    ...
    $.__views.__alloyId86.add($.__views.userImage);
    ...
    $.__views.__alloyId86.add($.__views.nameLabel);
    $.__views.dateLabel = Ti.UI.createLabel({
        left: "75",
        top: "20",
        id: "dateLabel"
    });
    $.__views.__alloyId86.add($.__views.dateLabel);
    ...
    $.__views.__alloyId85.add($.__views.commentLabel);
    $.__views.mainAttachmentImage = Ti.UI.createImageView({
        id: "mainAttachmentImage"
    });
    $.__views.__alloyId85.add($.__views.mainAttachmentImage);
    ...
    ExternalFileClick ? $.__views.__alloyId87.addEventListener("click", ExternalFileClick) : __defers["$.__views.__alloyId87!click!ExternalFileClick"] = true;
    $.__views.extAttachmentImage = Ti.UI.createImageView({
        id: "extAttachmentImage",
        top: "0",
        left: "0"
    });
    $.__views.__alloyId87.add($.__views.extAttachmentImage);
    ...
    $.__views.__alloyId87.add($.__views.extAttachmentFileNameLabel);
    ...
    $.__views.__alloyId85.add($.__views.replyTable);
    ...
    $.__views.__alloyId85.add($.__views.attachmentCountLabel);
    $.__views.replyCountLabel = Ti.UI.createLabel({
        id: "replyCountLabel",
        visible: "false"
    });
    $.__views.__alloyId85.add($.__views.replyCountLabel);
    $.__views.attachmentExtLabel = Ti.UI.createLabel({
        id: "attachmentExtLabel",
        visible: "false"
    });
    $.__views.__alloyId85.add($.__views.attachmentExtLabel);
    $.__views.postidLabel = Ti.UI.createLabel({
        id: "postidLabel"
    });
    $.__views.__alloyId85.add($.__views.postidLabel);
    ...
    __defers["$.__views.__alloyId87!click!ExternalFileClick"] && $.__views.__alloyId87.addEventListener("click", ExternalFileClick);
